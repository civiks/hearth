...
const collapsed = useLocalStorage("hs.digest.pro.collapsed", false);
...
function buildLines(): string[] {
  ...
  if (f.deltaPct !== null) {
    if (f.deltaPct > 10) {
      ...
      lines.push(
        `Activity is steady — **${f.recentCompleted}** completed in the last 30 days, in line with the prior month.`,
      );
    }
