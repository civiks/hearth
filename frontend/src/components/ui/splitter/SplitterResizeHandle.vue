...
<template>
  ...
  >
    ...
    >
      <PhDotsSixVertical class="size-3 text-muted-foreground transition-colors group-data-[resize-handle-state=hover]/handle:text-primary group-data-[resize-handle-state=drag]/handle:text-primary" weight="bold" />
    </div>
