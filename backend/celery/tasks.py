...
@shared_task(ignore_result=True, name="email_reminder")
def email_reminder(to: str, subject: str, content: str) -> None:
    send_email(to, subject, content)


@shared_task(ignore_result=True, name="send_daily_reminders")
...
@shared_task(bind=True, ignore_result=True, name="generate_monthly_report")
...
@shared_task(bind=True, ignore_result=True, name="generate_activity_report")
